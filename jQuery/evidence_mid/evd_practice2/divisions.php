...
<head>
    ...
    <style>
        #districts{border: 2px solid black; padding: 5px; font-size: larger; font-weight: bolder; background-color: seagreen; color: white; margin-left: 50px;}
        #divsions_id{border: 2px solid black; padding: 5px; font-size: larger; font-weight: bolder; background-color: seagreen; color: white;}
