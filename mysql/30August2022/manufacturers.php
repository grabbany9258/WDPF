...
// For Entry
    if(isset($_POST['manu_submit'])){
       ...
       $sql = "CALL manufacture_entry('$manu_name', '$manu_address', '$manu_contact')";
       $db->query($sql);
       if($db->affected_rows>0){
...
<h1> manufacturers List</h1>
    ...
    <h1>Manufacturer Entry</h1>
        <form action="" method="post">
            <input type="text" name="manu_name" placeholder="Manufacturer Name"> <br>
            <input type="text" name="manu_address" placeholder="Manufacturer Address "> <br>
            <input type="text" name="manu_contact" placeholder="Manufacturer Contact"> <br>
